...
Wyrmix MUST use git, specifically Github for all projects. 
...
- [Source](https://github.com/Wyrmixinc/cool-project)
- [JIRA](Wyrmixinc.atlassian.net/insane-jira-url-to-project)
...
All Android Projects at The Wyrmix MUST use CI.
...
the reason The Wyrmix Android Developers have adopted
